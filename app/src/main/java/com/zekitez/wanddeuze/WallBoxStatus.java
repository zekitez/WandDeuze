...
public class WallBoxStatus {
    ...
    static final int STATUS_NOT_CONNECTED = 0;
    static final int STATUS_READY = 161;
    static final int STATUS_WAIT_NEXT_SCHEDULE_8 = 178;
    static final int STATUS_WAIT_NEXT_SCHEDULE_9 = 179;
